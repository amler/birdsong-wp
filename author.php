...
?>
				...
				<h1 class="page-title author"><?php printf( __( 'Author Archives: %s', 'birdsong' ), "<span class='vcard'><a class='url fn n' href='" . get_author_posts_url( get_the_author_meta( 'ID' ) ) . "' title='" . esc_attr( get_the_author() ) . "' rel='me'>" . get_the_author() . "</a></span>" ); ?></h1>
...
if ( get_the_author_meta( 'description' ) ) : ?>
					<div id="entry-author-info">
						<div id="author-avatar">
							<?php
							/**
							 * Filter the Birdsong Gregory author bio avatar size.
							 *
							 * @since Birdsong Gregory 1.0
							 *
